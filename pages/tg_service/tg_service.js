...
Page({
    ...
    selects: function (e) {
        ...
        var that = this;
        that.setData({
            ids: that.data.data[e.currentTarget.dataset.num].id,
            tprice: that.data.data[e.currentTarget.dataset.num].promotionalPrice,
            lprice: that.data.data[e.currentTarget.dataset.num].originalPrice
        })
        id = that.data.data[e.currentTarget.dataset.num].id
    },
    pay: function (e) {
        wx.request({
